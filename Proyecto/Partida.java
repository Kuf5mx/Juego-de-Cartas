...
public class Partida {
    ...
    private final String[] CAMPOS = {"Llanura de Fuego", "Bosque de Pasto", "Oceano de Agua", "Valle de Rayo"};
    ...
    private void jugarTurno(Scanner scanner, Jugador actual, Jugador rival, int turno, String campoActual) {
        System.out.println("\n================================================");
    ...
    private boolean atacar(Jugador atacante, Jugador defensor, String campoActual) {
        ...
        if (bonoBanca > 0) {
            ...
            if (bonos.length() > 0) bonos.append(", ");
            bonos.append("banca defensiva -" + bonoBanca);
        }
    ...
    private void registrar(String evento) {
        resumenPartida.add(evento);
    }

    private String nombreSeguro(Carta carta) {
    ...
    private void mostrarResumenPartida() {
        ...
        for (String evento : resumenPartida) System.out.println("- " + evento);
        System.out.println("==================================================");
    }
    ...
    private boolean tieneDesventaja(String tipoPokemon, String campo) {
    ...
    private String siguienteDe(String nombre) {
    ...
    private void pokemon(Map<String, Carta> c, String n, int v, int d, String t, int f, String a, boolean e, String h) {
        c.put(n, new Carta(n, v, d, false, t, f, a, e, h));
    }

    private void mostrarArbol(Map<String, Carta> catalogo) {
    ...
    private void personalizarMazo(Scanner scanner, Jugador jugador, Carta[] catalogo) {
    ...
    private String evolucionAnterior(String nombre) {
